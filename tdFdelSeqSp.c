 ...
 *     @(#) $Id: ACMM:2dFdelta/tdFdelSeqSp.c,v 3.17 25-Aug-2014 14:38:02+10 tjf $
...
static char *rcsId="@(#) $Id: ACMM:2dFdelta/tdFdelSeqSp.c,v 3.17 25-Aug-2014 14:38:02+10 tjf $";
...
static void MoveSort(
    ...
    const INT32     * const pivotX,
    const INT32     * const pivotY,
    const INT32     * const xf,
    const INT32     * const yf,
