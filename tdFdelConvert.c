 ...
 *      @(#) $Id: ACMM:2dFdelta/tdFdelConvert.c,v 3.17 25-Aug-2014 14:38:03+10 tjf $ */
...
static char *rcsId="@(#) $Id: ACMM:2dFdelta/tdFdelConvert.c,v 3.17 25-Aug-2014 14:38:03+10 tjf $";
        ...
        StatusType   *status)
{
     ...
     *  this list to more elements (FPIL_MAXPIVOTS) then we actually will
        ...
        StatusType   *status)
{
    ...
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,cField->fvpX,&actlen,status);
    SdsFreeId(tmpId,status);
    ArgFind(curId,"fvpY",&tmpId,status);
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,cField->fvpY,&actlen,status);
    SdsFreeId(tmpId,status);
    ArgFind(curId,"xf",&tmpId,status);
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,cField->xf,&actlen,status);
    SdsFreeId(tmpId,status);
    ArgFind(curId,"yf",&tmpId,status);
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,cField->yf,&actlen,status);
    SdsFreeId(tmpId,status);
    ArgFind(curId,"xb",&tmpId,status);
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,cField->xb,&actlen,status);
    SdsFreeId(tmpId,status);
    ArgFind(curId,"yb",&tmpId,status);
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,cField->yb,&actlen,status);
    SdsFreeId(tmpId,status);
        ...
        StatusType    *status)
{
    ...
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,con->xPark,&actlen,status);
    SdsFreeId(tmpId,status);
    ArgFind(conId,"yPark",&tmpId,status);
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,con->yPark,&actlen,status);
    SdsFreeId(tmpId,status);
    ArgFind(conId,"xPiv",&tmpId,status);
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,con->xPiv,&actlen,status);
    SdsFreeId(tmpId,status);
    ArgFind(conId,"yPiv",&tmpId,status);
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,con->yPiv,&actlen,status);
    SdsFreeId(tmpId,status);
    ...
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,con->graspX,&actlen,status);
    SdsFreeId(tmpId,status);
    ArgFind(conId,"graspY",&tmpId,status);
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,con->graspY,&actlen,status);
    SdsFreeId(tmpId,status);
        ...
        StatusType    *status)
{
    ...
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,tar->fvpX,&actlen,status);
    SdsFreeId(tmpId,status);
    ArgFind(tarId,"fvpY",&tmpId,status);
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,tar->fvpY,&actlen,status);
    SdsFreeId(tmpId,status);
    ArgFind(tarId,"xf",&tmpId,status);
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,tar->xf,&actlen,status);
    SdsFreeId(tmpId,status);
    ArgFind(tarId,"yf",&tmpId,status);
    SdsGet(tmpId,sizeof(INT32)*numPivots,0,tar->yf,&actlen,status);
    SdsFreeId(tmpId,status);
