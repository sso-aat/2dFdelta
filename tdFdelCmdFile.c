 ...
 *  @(#) $Id: ACMM:2dFdelta/tdFdelCmdFile.c,v 3.5 18-Feb-2005 17:31:34+11 tjf $ (mm/dd/yy)
 */
...
static char *rcsId="@(#) $Id: ACMM:2dFdelta/tdFdelCmdFile.c,v 3.5 18-Feb-2005 17:31:34+11 tjf $";
