 ...
 *     @(#) $Id: ACMM:2dFdelta/tdFdelFieldCh.c,v 3.4 08-Oct-2004 13:24:01+10 tjf $
 */
...
static char *rcsId="@(#) $Id: ACMM:2dFdelta/tdFdelFieldCh.c,v 3.4 08-Oct-2004 13:24:01+10 tjf $";
